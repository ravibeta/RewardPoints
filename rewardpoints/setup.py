        ...
        response = cf_client.create_stack(
            ...
            Parameters=[
                ...
                },
                {
                    ...
                    'ParameterValue': 'RewardPointDB'
                },
                {
                    'ParameterKey': 'DBPassword',
                    'ParameterValue': 'RewardPointPassw0rd'
                }
            ],
...
def setup(project_name='spring-rewardpoint-rest',
          service_list={'spring-rewardpoint-rest-system': '8080','spring-rewardpoint-rest-owner': '8080', 'spring-rewardpoint-rest-pet': '8080','spring-rewardpoint-rest-vet': '8080','spring-rewardpoint-rest-visit': '8080'}
          , region='us-west-2'):
    ecr_client = boto3.client('ecr')
    ...
    my_sql_options = {'dns_name': dns_name, 'username': 'RewardPointDB', 'password': 'RewardPointPassw0rd'}
    ...
    for service in service_list:
        ...
        if service == 'spring-rewardpoint-rest-system':
...
def cleanup(project_name='spring-rewardpoint-rest',
            service_list={'spring-rewardpoint-rest-system': '8080','spring-rewardpoint-rest-owner': '8080', 'spring-rewardpoint-rest-pet': '8080','spring-rewardpoint-rest-vet': '8080','spring-rewardpoint-rest-visit': '8080'}, region='us-west-2'):
    ecr_client = boto3.client('ecr')
    ecs_client = boto3.client('ecs')
...
def main():
    ...
    parser.add_argument('-p', '--project_name', required=False, default='spring-rewardpoint-micro',
                        help="Name of the project")
    parser.add_argument('-r', '--region', required=True, help="Region is required.")
    parser.add_argument('-s', '--service_list', required=False,
                        default={'spring-rewardpoint-rest-system': '8080','spring-rewardpoint-rest-owner': '8080', 'spring-rewardpoint-rest-pet': '8080','spring-rewardpoint-rest-vet': '8080','spring-rewardpoint-rest-visit': '8080'},
                        help="Service list. Default {'spring-rewardpoint-rest-owner' : '8080',"
                             "'spring-rewardpoint-rest-pet' : '8080','spring-rewardpoint-rest-system' : '8080',"
                             "'spring-rewardpoint-rest-vet' : '8080','spring-rewardpoint-rest-visit' : '8080'}")
